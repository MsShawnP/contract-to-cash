...
Revenue lifecycle analysis for mid-market CPG brands — tracing contracts through shipment, deductions, and payment. Second buyer-facing consumer of the Cinderhaven Data Platform. Demonstrates production-grade data engineering to technical reviewers while telling the RevOps business story to CFOs/CEOs.

**Business question this project answers:** On that deal we signed in Q1 — what did we actually net, and where did the money leak between systems?
...
Stack TBD — to be determined through /clarify.
